            ...
            {isEditing ? (
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-medium text-[#0d212c] bg-white border border-[#cbd5e1] rounded-xl px-4 py-2.5 outline-none focus:border-[#e2e8f0] transition"
            ...
            <div className="bg-[#f8fafc] border border-[#e2e8f0] p-4 rounded-xl flex flex-col gap-1.5">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs text-[#0d212c] bg-white border border-[#cbd5e1] rounded-lg p-2.5 outline-none focus:border-[#e2e8f0] transition resize-y font-normal"
            ...
            <form onSubmit={handleAddQuestion} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 rounded-xl border border-[#cbd5e1] text-xs font-medium text-[#0d212c] outline-none bg-white focus:border-[#e2e8f0] transition"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={3}
                  className="w-full px-4 py-2.5 rounded-xl border border-[#cbd5e1] text-xs font-medium text-[#0d212c] outline-none bg-white resize-y focus:border-[#e2e8f0] transition"
                />
              </div>
