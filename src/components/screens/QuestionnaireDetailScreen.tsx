            ...
            <div className="bg-[#f8fafc] border border-[#e2e8f0] p-4 rounded-xl flex flex-col gap-1.5">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs text-[#0d212c] bg-white border border-[#cbd5e1] rounded-lg p-2.5 outline-none focus:border-[#e2e8f0] focus:ring-0 transition resize-y font-normal"
